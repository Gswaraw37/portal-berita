...
<body>
    ...
    <div class="daftar-tulisan-saya mx-4">
        <div class="container-fluid">
            <h3 class="m-0">Tulisan Pertama Saya</h3>
            <h6 class="m-0">Kategori : Ekonomi</h6>
            <div class="edit text-end"><a href="" class="px-3">edit</a></div>
            <p>Dalam era digital ini, kemampuan untuk mengekspresikan ide melalui tulisan telah menjadi keterampilan
                yang
                semakin penting. Menulis untuk web tidak hanya melibatkan kemampuan menyusun kalimat yang baik, tetapi
                juga
                memahami cara menarik perhatian pembaca online yang cepat dan mudah teralihkan. Dengan begitu banyak
                informasi
                yang bersaing untuk perhatian kita, menulis untuk web mengharuskan kita untuk memikirkan strategi
                komunikasi
                yang efektif.</p>
            <p class="text-end"><small>Terakhir diedit 1 April | 12:53</small></p>
            <hr>
        </div>
    </div>
    <div class="daftar-tulisan-saya mx-4">
        <div class="container-fluid">
            <h3 class="m-0">Tulisan Kedua Saya</h3>
            <h6 class="m-0">Kategori : Ekonomi</h6>
            <div class="edit text-end"><a href="" class="px-3">edit</a></div>
            <p>Dalam era digital ini, kemampuan untuk mengekspresikan ide melalui tulisan telah menjadi keterampilan
                yang
    ...
    <div class="delete-icon text-center p-2" style="background-color: #383961;">
        <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 45 45" fill="none">
                <path
