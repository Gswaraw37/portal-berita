        ...
        <div class="top-bar align-items-center p-2">
            ...
            <div class="nav-btn">
                @if (Auth::user('guest'))
                    ...
                    <button type="button" style="width:50px;" class="masuk mx-1 me-4 btn btn-danger dropdown-toggle dropdown-toggle-split fa fa-circle-user" data-bs-toggle="dropdown" aria-expanded="false"></button>
