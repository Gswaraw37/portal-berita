...
<body>
    ...
    <header>
        ...
        <div class="top-bar align-items-center p-2">
            ...
            <div class="me-2">
                <form class="search-bar" role="search" action="/">
                    <input class="form-control" type="text" id="search-bar" name="search" placeholder="Cari di sini" />
                    <button class="btn btn-outline-success" style="display: flex; place-items: center" type="submit">
